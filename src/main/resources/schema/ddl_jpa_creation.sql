...
alter table groupe add constraint FKp59mphxh8am13rry5wrxvgn1c foreign key (job_id) references job on delete cascade;
alter table job add constraint FK3ty91eq8oeii1l7u0s71d9i47 foreign key (developer_id) references person on delete cascade;
alter table todo add constraint FKt4goeu4k0iv12fofnnc9cnw7o foreign key (person_id) references person on delete cascade;
alter table todo_tag add constraint FK3w1xrmwsoykr0mqgah1yhfjqt foreign key (tag_id) references tag on delete cascade;
alter table todo_tag add constraint FKjb2k1x5n6dkhyjpht94d3ynnu foreign key (todo_id) references todo on delete cascade;
