...
public abstract class WmAbstractCommand extends Message {
	...
	public WmAbstractCommand(String subject, String source, String destination, String GTX, String LTX, String FLTX,
			String PGTX, String additionalHeaders, String payload, String traceId) {
	...
	public WmAbstractCommand(String pool,String subject, String source, String destination, String gTX, String lTX, String fLTX,
	...
	public String toString() {
		return "Command{" + "id='" + this.getId() + '\'' + ", startedTimestamp=" + startedTimestamp + ", subject='"
				+ subject + '\'' + ", source='" + source + '\'' + ", destination='" + destination + '\'' + ", GTX='"
				+ GTX + '\'' + ", LTX='" + LTX + '\'' + ", FLTX='" + FLTX + '\'' + ", PGTX='" + PGTX + '\''
				+ ", additionalHeaders='" + additionalHeaders + '\'' + ", payload='" + payload + '\'' + '}';
	}
}
